...
class PreferencePageC extends StatefulWidget {
  const PreferencePageC({super.key});

  @override
  _PreferencePageCState createState() => _PreferencePageCState();
}

class _PreferencePageCState extends State<PreferencePageC> {
  @override
        ...
        children: [
          ...
          Positioned(
            ...
            child: Column(
              children: [
                const Text(
                  "What are you looking for?", // Text above the buttons
                  style: TextStyle(
                    fontSize: 20,
                ...
                InkWell(
                  onTap: () {
                    // Navigate to 2dIntrest when the button is pressed
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const TwoDInterestPage()),
                    );
                  },
                  child: Container(
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const ThreeDInterestPage()),
                    );
                  },
                  child: Container(
                    width: 300, // Increased button width
